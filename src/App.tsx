...
import { hydrateSettings, useBroadcastStore, useSettingsStore } from "@/stores"
  ...
  useEffect(() => {
    void hydrateSettings().then(() => {
      ...
      useBroadcastStore.setState({
        ...
        cameraFit: settings.cameraFit,
        cameraMirrored: settings.cameraMirrored,
        lowerThirdThemeId: settings.lowerThirdThemeId,
      })
      ...
      void emit("projector:calibration", {
        insets: settings.projectorCalibration,
        editing: false,
      }).catch(() => {})
    })
  }, [])
