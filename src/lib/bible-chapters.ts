// Chapter counts for the standard 66-book Protestant canon.
// Keyed by Book.book_number (1 = Genesis ... 66 = Revelation).
...
export function chaptersIn(bookNumber: number): number {
